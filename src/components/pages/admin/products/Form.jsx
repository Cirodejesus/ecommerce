...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!params.id) {
      axios
        .post(`${API_URL}/admin/productos`, body, {
          headers: {
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-2 gap-6 mb-6">
            ...
            <div className="flex flex-col">
              ...
              >
                <option defaultValue="Otros" disabled selected>
                  Selecciona una categoría
                </option>
                <option defaultValue="Hogar">Hogar</option>
                <option defaultValue="Tecnología">Tecnología</option>
                <option defaultValue="Deportes">Deportes</option>
                <option defaultValue="Moda">Moda</option>
                <option defaultValue="Juguetes">Juguetes</option>
              </select>
            </div>
...
export default Form
// rsf especificación para componente funcional
